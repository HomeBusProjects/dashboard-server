...
class CamerasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create camera" do
    assert_difference('Camera.count') do
      post cameras_url, params: { camera: { homebus_uuid: @camera.homebus_uuid, name: @camera.name, public: @camera.public } }
    end
  ...
  test "should update camera" do
    patch camera_url(@camera), params: { camera: { homebus_uuid: @camera.homebus_uuid, name: @camera.name, public: @camera.public } }
