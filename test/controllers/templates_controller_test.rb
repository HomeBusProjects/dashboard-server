...
class TemplatesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create template" do
    assert_difference('Template.count') do
      post templates_url, params: { template: { ddc: @template.ddc, name: @template.name, template: @template.template } }
    end
  ...
  test "should update template" do
    patch template_url(@template), params: { template: { ddc: @template.ddc, name: @template.name, template: @template.template } }
